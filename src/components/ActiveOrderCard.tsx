      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span
              className={`px-2 py-1 text-xs font-medium rounded-full border ${statusCssClass}`}
            >
          ...
          <p className="text-xs text-gray-500">
            {order.items_count || 0} товар(ов) •{' '}
            {order.time_since_created || 'Время неизвестно'}
          </p>
        </div>
