    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div className="space-y-3">
          {items.map((item) => (
            <div key={`${item.item_id}-${JSON.stringify(item.selectedOptions)}`} className="bg-white rounded-lg p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <button
                        onClick={() => handleQuantityChange(item.item_id, (item.cartQuantity || 1) - 1)}
                  ...
                  <div className="mt-2 text-right">
                    <span className="text-sm font-medium text-gray-900">
                      Итого: {((item.price * (item.cartQuantity || 1)) / 1).toFixed(2)} ₸
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-2">
            ...
            <div className="border-t pt-2">
              <div className="flex justify-between">
                ...
                <span className="text-lg font-bold text-orange-500">{getTotalPrice().toFixed(2)} ₸</span>
              </div>
            </div>
          </div>
